...
const happiness_feature_type_to_name: Dictionary = {
	 HappinessStats.HappinessFeatureType.FOOD: "Food",
	 HappinessStats.HappinessFeatureType.OXYGEN: "Oxygen",
}
...
func fill_infos(entity_infos: EntityInfos, happiness: HappinessStats) -> void:
	...
	for happiness_key: HappinessStats.HappinessFeatureType in happiness_features:
		...
		var display_feature_name: String = happiness_feature_type_to_name[happiness_key]
